...
<script>
    ...
    const pageName = currentURL.split('/')[3];
    ...
    switch (pageName) {
        ...
        case "items":
            ...
            document.getElementById("menu-product").classList.add("show");
            break;

        case "orders":
            document.getElementById("invoices-link").classList.add("active");
            document.getElementById("menu-order").classList.add("show");
            break;
        case "customers":
            document.getElementById("customers-link").classList.add("active");
            document.getElementById("customers-info").classList.add("show");
            break;
        case "users":
